...
export default function DormDetailPage() {
  ...
  return (
    <div style={{ background: "#ffffff", minHeight: "100vh", fontFamily: '"Noto Sans Thai", sans-serif' }}>
      ...
      >
        {/* Light Green Gradient Overlay matching mockup */}
        <div
          style={{
            position: "absolute",
            top: 0,
            ...
            right: 0,
            bottom: 0,
            background: "linear-gradient(90deg, rgba(230, 243, 227, 0.96) 0%, rgba(230, 243, 227, 0.85) 45%, rgba(255, 255, 255, 0.05) 100%)",
            zIndex: 1
          }}
        ></div>
      ...
      {/* =====================================================
                FLOATING OVERLAPPING SEARCH & CONTENT
      ===================================================== */}
      <div style={{ position: "relative", zIndex: 10, maxWidth: "1120px", margin: "-65px auto 0", padding: "0 30px 60px" }}>
        
        {/* Floating Overlapping Search Card matching mockup media_1788883447037.png */}
        <div
          style={{
        ...
        >
          ...
          >
            <div>
              <label style={{ display: "block", fontSize: "13.5px", fontWeight: 600, color: "#1e293b", marginBottom: "6px" }}>ชื่อหอพัก</label>
              <SearchableSelect
            ...
            <div>
              <label style={{ display: "block", fontSize: "13.5px", fontWeight: 600, color: "#1e293b", marginBottom: "6px" }}>พื้นที่</label>
              <SearchableSelect
            ...
            <div>
              <label style={{ display: "block", fontSize: "13.5px", fontWeight: 600, color: "#1e293b", marginBottom: "6px" }}>ช่วงราคา</label>
              <SearchableSelect
            ...
            <div>
              <label style={{ display: "block", fontSize: "13.5px", fontWeight: 600, color: "#1e293b", marginBottom: "6px" }}>ประเภทห้อง</label>
              <SearchableSelect
